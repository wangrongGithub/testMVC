...
import cn.wr.SpringBoot.Service.CustomUserDetailsService;
import cn.wr.SpringBoot.Service.LoginSuccessHandler;
...
//加载的时候会创建这个类；会调用这个类的init 方法从而会用getHttp方法
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
   ...
   // AbstractAuthenticationProcessingFilter
    ...
    protected void configure(AuthenticationManagerBuilder auth)
            throws Exception {
        //放入service以及passwordEncoder啊  customUserDetailsService提供用户在数据库里面的信息；
    ...
    public CustomFilterSecurityInterceptor customFilter() throws Exception{
        ...
        customFilter.setAuthenticationManager(authenticationManager);//设置授权的Manager
        return customFilter;
    }
